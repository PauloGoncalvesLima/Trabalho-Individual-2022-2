...
import numpy as np
from trabalho_individual_gces_2022_paulo.data_pipeline.feature_engineering.word_embedding import (
    WordEmbedding,
)


@pytest.mark.parametrize("lang, dimensions", [("en", 25), ("es", 50), ("fr", 100)])
