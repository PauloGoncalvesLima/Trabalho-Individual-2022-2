...
from trabalho_individual_gces_2022_paulo.data_pipeline.feature_engineering.key_smash import (
    KeySmash,
)


@pytest.mark.parametrize(
    "text, expected", [("PUENTECILLA KM. 1.7", 1.121212121212121), ("ASDASD XXXX", 3.0)]
)
...
@pytest.mark.parametrize("text, expected", [("ABC 123 !@#", 0.0), ("ABC123 !@#", 0.9)])
